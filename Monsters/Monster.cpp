    ...
    for (int i = 0; !MonsterJson["monster"][i]["name"].empty(); i++) {
      ...
      if (MonsterJson["monster"][i]["name"] == E_M.Challenge_rating[challenge_rating_][name_]) {
        ...
        if (MonsterJson["monster"][i].find("hp") != endPointer) {
          if (MonsterJson["monster"][i]["hp"].find("average") != MonsterJson["monster"][i]["hp"].end())
            health = MonsterJson["monster"][i]["hp"]["average"];
        ...
        if (MonsterJson["monster"][i].find("speed") != endPointer) {
          ...
          if (MonsterJson["monster"][i]["speed"].find("fly") != MonsterJson["monster"][i]["speed"].end()) {
            if (MonsterJson["monster"][i]["speed"]["fly"].find("fly")
                != MonsterJson["monster"][i]["speed"]["fly"].end()) {
              speed[3] = MonsterJson["monster"][i]["speed"]["fly"]["fly"];
            } else speed[3] = MonsterJson["monster"][i]["speed"]["fly"];
            if (MonsterJson["monster"][i]["speed"]["fly"].find("condition")
                != MonsterJson["monster"][i]["speed"]["fly"].end()) {
        ...
        if (MonsterJson["monster"][i].find("str")
            != endPointer) { // TODO: check whether it enough to say that all abilities are present
        ...
        if(MonsterJson["monster"][i].find("isNamedCreature") != MonsterJson["monster"][i].end()) isNamedCreature = MonsterJson["monster"][i]["isNamedCreature"];
        ...
        if(MonsterJson["monster"][i].find("legendaryGroup") != MonsterJson["monster"][i].end()) legendaryGroup = MonsterJson["monster"][i]["legendaryGroup"];
        if(MonsterJson["monster"][i].find("legendaryActions") != MonsterJson["monster"][i].end()) legendaryGroup = MonsterJson["monster"][i]["legendaryActions"];
        variant = commonVariantParse(MonsterJson["monster"][i], ""); // "" - not needed
        break;
      }
    }

...
struct Monster_Parameters_Names{
  vector <string> intVar = {"maxhealth", "health", "health_dice", "health_dice_num", "health_modifier", "armor_class", "speed[walk]", "speed[swim]", "speed[climb]", "speed[fly]", "Str", "Dex", "Con", "Int", "Wis", "Cha", "passive_perception", "legendary_actions"};
  vector <string> boolVar = {"can_hover", "is_named_creature"};
  vector <string> stringVar = {"monster_name", "size", "challenge_rating", "hp_formula", "type_s", "fly_condition", "saving_throws[Str]", "saving_throws[Dex]", "saving_throws[Con]", "saving_throws[Int]", "saving_throws[Wis]", "saving_throws[Cha]",
                               "acrobatics", "animalHandling", "arcana", "athletics", "deception", "history",
                               "insight", "intimidation", "investigation", "medicine", "nature",
                               "perception", "performance", "persuasion", "religion", "sleightOfHand",
                               "stealth", "survival", "legendary_group"};
  vector <string> vectorStringVar = {"type_tags", "alignment", "acFrom", "resistance", "resistance_note", "immune", "condition_imune", "senses", "languages", "trait", "action", "legendary", "spellcasting_name_and_entries", "spellcasting_will", "trait_tags", "action_tags", "language_tags", "sense_tags", "variant"};
  int fakeParameter;
};
